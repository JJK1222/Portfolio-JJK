...
function homepage_fullpage() {
  ...
  $('#homepage-fullpage').fullpage({
    ...
    menu: '#menu',
    lockAnchors: false,
    anchors: ['','certificate', 'degree', 'career', 'design-tool', 'publishing-tool', 'vs-code'],
    navigation: true,
    navigationPosition: 'right',
    navigationTooltips: ['','CERTIFICATE', 'DEGREE', 'CAREER', 'DESIGN TOOL', 'PUBLISHING TOOL', 'VS CODE'],
    ...
    sectionsColor : ['#f6f4fc', '#f6f4fc','#f6f4fc', '#f6f4fc','#f6f4fc', '#f6f4fc'],
    paddingTop: '0em',
    paddingBottom: '0em',
